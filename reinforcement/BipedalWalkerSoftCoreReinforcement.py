...
class Critic_Model:
    def __init__(self, input_shape, action_space, lr, optimizer):
        ...
        V = Dense(512, activation=activation, kernel_initializer=kernel_initializer)(X_input)
        V = Dense(256, activation=activation, kernel_initializer=kernel_initializer)(V)
        V = Dense(128, activation=activation, kernel_initializer=kernel_initializer)(V) #Added an extra layer, hopefully will help with Hardcore
        V = Dense(64, activation=activation, kernel_initializer=kernel_initializer)(V)
        X = Dense(32, activation=activation, kernel_initializer=kernel_initializer)(V) #Added an extra layer, hopefully will help with Hardcore
...
if __name__ == "__main__":
    env_name = 'BipedalWalker-v3' #Run testing on trial 4 for graph for EE
